...
function Category ({value}) {
  ...
  {category.map((cat) => {
    return (
      ...
      <div key={cat.id} className=" cursor-pointer transform transition-all mx-auto w-full h-96 flex flex-col border-2 border-blue-500 rounded-lg	 p-10 lg:hover:scale-110 ">
